...
namespace MultiShop.IdentityServer
{
    public static class Config
    {
        ...
        public static IEnumerable<ApiScope> ApiScopes => new ApiScope[]
        {
            ...
            new ApiScope("ImageFullPermission","Reading authority for image operations"),
        ...
        public static IEnumerable<Client> Clients => new Client[]
        {
            ...
            new Client
            {
                ...
                AllowedScopes={"CatalogReadPermission", "CatalogFullPermisson", "OcelotFullPermission", "CommentFullPermission", "ImageFullPermission",
            ...
            new Client
            {
                ...
                AllowedScopes={ "CatalogReadPermission", "CatalogFullPermisson", "BasketFullPermission", "OcelotFullPermission", "CommentFullPermission", "PaymentFullPermission", "ImageFullPermission","DiscountFullPermission",
                IdentityServerConstants.LocalApi.ScopeName,
